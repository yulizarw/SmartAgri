...
exports.generateRecommendation = async (req, res) => {
  try {
    ...
    const result =
      await RecommendationService.generateRecommendation(cropHealthId);
...
exports.getLatestRecommendation = async (req, res) => {
  try {
    ...
    const result =
      await RecommendationService.getLatestRecommendation(cropHealthId);
    ...
    console.error("getLatestRecommendation error:", error);
